                    ...
                    <form action="{{ url('invoices/update/') }}" method="post"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Sections" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    onchange="console.log('change is firing')">
                                    <!--placeholder-->
                                    <option value="{{$invoices->sections->id}}"{{$invoices->sections->section_name}}>حدد القسم</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_vat" id="Rate_vat" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="{{$invoices->Rate_vat}}"{{$invoices->Rate_vat}} selected disabled>حدد نسبة الضريبة</option>
