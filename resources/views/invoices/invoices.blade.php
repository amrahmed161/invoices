...
@section('content')
				...
				<div class="row">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div  class="dropdown-menu tx-13">
                                                                <a class="dropdown-item" href="{{url('edit_invoice')}}/{{$invoice->id}}">الفاتورة تعديل</a>
                                                                <a class="dropdown-item" href="#" data-invoices_id="{{$invoice->id}}"
                                                                    data-toggle="model" data-target="#delete_invoices"><i class="text-danger fas fa-trash-alt"></i>&nbsp;&nbsp;خدف</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                    ...
                    <div class="modal fade" id="delete_invoices" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
